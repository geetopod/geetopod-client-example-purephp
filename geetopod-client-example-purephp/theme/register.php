<?php
global $g_online, $g_sso_in_use, $captchaCode, $captchaImageUrl, $captchaText, $username, $email, $phone, $password, $passwordRetype, $firstName, $middleName, $lastName, $mailingAddress, $billingAddress, $country, $state, $postalCode, $message;
?>
<!DOCTYPE HTML>
<html>
<head>
    ...
    <title>Register | unapp Template</title>
                    ...
                    <form action="/register" method="POST">
                        ...
                        <div class="row form-group">
                            <div class="col-md-4">
                                ...
                                <input type="password" name="password" value="<?php print($password); ?>" class="form-control" />
                            </div>
                            <div class="col-md-4">
                                <label>Retype Password</label>
                                <input type="password" name="passwordRetype" value="<?php print($passwordRetype); ?>" class="form-control" />
                            </div>
                            <div class="col-md-4">
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="captchaText" value="<?php print($captchaText); ?>" />
                            </div>
                            <div class="col-md-4">
                                <input type="hidden" name="captchaCode" value="<?php print($captchaCode); ?>" />
                                <input type="hidden" name="captchaImageUrl" value="<?php print($captchaImageUrl); ?>" />
                                <label style="color: transparent">Enter captcha text</label>
                                <img src="<?php print($captchaImageUrl); ?>" />
                            </div>
                            <div class="col-md-4">
                            </div>
                        </div>
