<?php
global $g_online, $g_sso_in_use, $email, $message;
?>
<!DOCTYPE HTML>
<html>
<head>
    ...
    <title>Forgot Password | unapp Template</title>
                ...
                <div class="container">
                    <div class="col-md-12 col-md-offset-0">
                        <div class="animate-box">
                            ...
                            <p class="breadcrumbs"><span><a href="/">Home</a></span> <span>Forgot Password</span></p>
                        </div>
                    </div>
                </div>
            </div>
