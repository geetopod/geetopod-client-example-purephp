					...
					<div class="container">
						<div class="col-md-12 col-md-offset-0">
							<div class="animate-box">
								<h2>Portfolio</h2>
								<p class="breadcrumbs"><span><a href="/">Home</a></span> <span>Work</span></p>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="half animate-box">
								<div class="row no-gutters">
									<div class="col-md-12 col-md-push-12 no-gutters">
										<a href="#" class="work-img" style="background-image: url(/unapp/images/work-1.jpg);"></a>
									</div>
								</div>
							</div>
							<div class="half animate-box">
							...
							<div class="half animate-box">
								<div class="row no-gutters">
									<div class="col-md-12 no-gutters">
										<a href="#" class="work-img" style="background-image: url(/unapp/images/work-2.jpg);"></a>
									</div>
								</div>
							</div>
							<div class="half animate-box">
					...
					<div class="col-md-12">
						<div class="work-flex">
							<div class="half animate-box">
								<div class="row no-gutters">
									<div class="col-md-12 col-md-push-12 no-gutters">
										<a href="#" class="work-img" style="background-image: url(/unapp/images/work-3.jpg);"></a>
									</div>
								</div>
							</div>
							<div class="half animate-box">
					...
					<div class="col-md-12">
						<div class="work-flex">
							<div class="half animate-box">
								<div class="row no-gutters">
									<div class="col-md-12 no-gutters">
										<a href="#" class="work-img" style="background-image: url(/unapp/images/work-4.jpg);"></a>
									</div>
								</div>
							</div>
							<div class="half animate-box">
