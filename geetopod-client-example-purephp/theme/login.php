<?php
global $g_online, $g_sso_in_use, $username, $password, $message;
?>
<!DOCTYPE HTML>
<html>
<head>
    ...
    <title>Login | unapp Template</title>
            ...
            <div class="row">
                ...
                <div class="col-md-8 animate-box">
                    ...
                    <form id="loginForm" action="/login" method="POST">
                        <input type="hidden" name="ssoInUse" value="false" id="ssoInUse" />
                        ...
                        <div class="form-group">
                            <input onclick="$('#ssoInUse').val('false'); $('#loginForm').submit();" type="button" value="Login" class="btn btn-primary">
                            &nbsp;
                            <input onclick="$('#ssoInUse').val('true'); $('#loginForm').submit();" type="button" value="Single Sign On" class="btn btn-default">
                            &nbsp; &nbsp;
                            <a href="/forgot-password">Forgot Password</a>
                            &nbsp; &nbsp;
                            <br /><br />
                            <a href="/social/login/github">Login with Github</a>
                            &nbsp; &nbsp;
                            <a href="/social/login/stackoverflow">Login with Stackoverflow</a>
                            &nbsp; &nbsp;
                            <a href="/social/login/microsoft">Login with Microsoft</a>
                            &nbsp; &nbsp;
                            <a href="/social/login/linkedin">Login with LinkedIn</a>
                        </div>
                    </form>
                </div>
                <div class="col-md-2">
