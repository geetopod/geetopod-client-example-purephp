					...
					<div class="container">
						<div class="col-md-12 col-md-offset-0">
							<div class="animate-box">
								...
								<p class="breadcrumbs"><span><a href="/">Home</a></span> <span>Work  grid w/o text</span></p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-2 col-sm-3 col-xs-6 text-center animate-box">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(/unapp/images/item-5.jpg);">
					...
					<div class="col-md-2 col-sm-3 col-xs-6 text-center animate-box">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(/unapp/images/item-6.jpg);">
					...
					<div class="col-md-2 col-sm-3 col-xs-6 text-center animate-box">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(/unapp/images/item-7.jpg);">
								<p class="tag"><span class="new">New</span></p>
								<div class="cart">
									<p>
										<span class="addtocart"><a href="#"><i class="icon-cart"></i></a></span> 
					...
					<div class="col-md-2 col-sm-3 col-xs-6 text-center animate-box">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(/unapp/images/item-8.jpg);">
								<div class="cart">
									<p>
										<span class="addtocart"><a href="#"><i class="icon-cart"></i></a></span> 
										<span><a href="#"><i class="icon-eye"></i></a></span> 
					...
					<div class="col-md-2 col-sm-3 col-xs-6 text-center animate-box">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(/unapp/images/item-9.jpg);">
								<p class="tag"><span class="sale">Sale</span></p>
								<div class="cart">
									<p>
										<span class="addtocart"><a href="#"><i class="icon-cart"></i></a></span> 
					...
					<div class="col-md-2 col-sm-3 col-xs-6 text-center animate-box">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(/unapp/images/item-10.jpg);">
								<p class="tag"><span class="new">New</span></p>
								<div class="cart">
									<p>
										<span class="addtocart"><a href="#"><i class="icon-cart"></i></a></span> 
					...
					<div class="col-md-2 col-sm-3 col-xs-6 text-center animate-box">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(/unapp/images/item-11.jpg);">
								<div class="cart">
									<p>
										<span class="addtocart"><a href="#"><i class="icon-cart"></i></a></span> 
										<span><a href="#"><i class="icon-eye"></i></a></span> 
					...
					<div class="col-md-2 col-sm-3 col-xs-6 text-center animate-box">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(/unapp/images/item-12.jpg);">
								<p class="tag"><span class="new">New</span></p>
								<div class="cart">
									<p>
										<span class="addtocart"><a href="#"><i class="icon-cart"></i></a></span> 
					...
					<div class="col-md-2 col-sm-3 col-xs-6 text-center animate-box">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(/unapp/images/item-13.jpg);">
								<p class="tag"><span class="new">New</span></p>
								<div class="cart">
									<p>
										<span class="addtocart"><a href="#"><i class="icon-cart"></i></a></span> 
					...
					<div class="col-md-2 col-sm-3 col-xs-6 text-center animate-box">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(/unapp/images/item-14.jpg);">
								<p class="tag"><span class="new">New</span></p>
								<div class="cart">
									<p>
										<span class="addtocart"><a href="#"><i class="icon-cart"></i></a></span> 
					...
					<div class="col-md-2 col-sm-3 col-xs-6 text-center animate-box">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(/unapp/images/item-15.jpg);">
								<p class="tag"><span class="new">New</span></p>
								<div class="cart">
									<p>
										<span class="addtocart"><a href="#"><i class="icon-cart"></i></a></span> 
					...
					<div class="col-md-2 col-sm-3 col-xs-6 text-center animate-box">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(/unapp/images/item-16.jpg);">
								<p class="tag"><span class="new">New</span></p>
								<div class="cart">
									<p>
										<span class="addtocart"><a href="#"><i class="icon-cart"></i></a></span> 
